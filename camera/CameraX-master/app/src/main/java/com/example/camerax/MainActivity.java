...
public class MainActivity extends AppCompatActivity {
    ...
    private void startCamera() {
        ...
        ImageAnalysisConfig imgAConfig = new ImageAnalysisConfig.Builder().setLensFacing(CameraX.LensFacing.FRONT).setImageReaderMode(ImageAnalysis.ImageReaderMode.ACQUIRE_LATEST_IMAGE).build();
